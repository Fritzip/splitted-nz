      ...
      t.extend( e.options, E, !0 ),
        ...
        d( "preventDragEvent",
           function( e, t, n ) {
             ...
             o && o.getAttribute( "class" ) && e.type.indexOf( "mouse" ) > -1 &&
        ...
        d( "unbindEvents",
           function() {
             I || L(), v && clearInterval( v ),
               ...
               n && ( t.unbind( document, n.eventK, _.updateFullscreen ),
                      n.isFullscreen() &&
        ...
        d( "destroy",
           function() {
             w.captionEl && ( r && o.removeChild( r ),
               ...
               t.addClass( o, "pswp__ui--hidden" ), _.setIdle( !1 )
           } ),
        ...
        d( "initialZoomOut",
           function() { t.addClass( o, "pswp__ui--hidden" ) } ),
          ...
          d( "mouseUsed",
             function() {
               t.bind( document, "mousemove", M ),
                 ...
                 v = setInterval( function() { 2 == ++z && _.setIdle( !0 ) },
                                  w.timeToIdle / 2 )
             } ),
        w.fullscreenEl && !t.features.isOldAndroid &&
          ( n || ( n = _.getFullscreenAPI() ),
            n ? ( t.bind( document, n.eventK, _.updateFullscreen ),
                  _.updateFullscreen(),
        ...
        w.preloaderEl &&
          ( A( !0 ),
            ...
            d( "imageLoadComplete",
               function( t, n ) { e.currItem === n && A( !0 ) } ) )
    },
    _.setIdle = function( e ) { c = e, S( o, "ui--idle", e ) },
    _.update  = function() {
      T && e.currItem
      ...
      o &&
        setTimeout( function() { e.setScrollOffset( 0, t.getScrollY() ) }, 50 ),
        t[( n.isFullscreen() ? "add" : "remove" ) + "Class"]( e.template,
                                                              "pswp--fs" )
    }, _.updateIndexIndicator = function() {
      w.counterEl && ( i.innerHTML = e.getCurrentIndex() + 1 +
                                     w.indexIndicatorSep + w.getNumItemsFn() )
    }, _.onGlobalTap = function( n ) {
      var o = ( n = n || window.event ).target || n.srcElement;
      if ( !g )
        if ( n.detail && "mouse" === n.detail.pointerType ) {
          if ( y( o ) ) return void e.close();
          t.hasClass( o, "pswp__img" ) &&
            ( 1 === e.getZoomLevel() && e.getZoomLevel() <= e.currItem.fitRatio
                ? w.clickToCloseNonZoomable && e.close()
                : e.toggleDesktopZoom( n.detail.releasePoint ) )
        } else if ( w.tapToToggleControls &&
                      ( T ? _.hideControls() : _.showControls() ),
                    w.tapToClose && ( t.hasClass( o, "pswp__img" ) || y( o ) ) )
          return void e.close()
    }, _.onMouseOver = function( e ) {
      var t = ( e = e || window.event ).target || e.srcElement;
      S( o, "ui--over-close", y( t ) )
      ...
      var e = document;
      return !!( e.exitFullscreen || e.mozCancelFullScreen ||
                 e.webkitExitFullscreen || e.msExitFullscreen )
      ...
      return n.requestFullscreen
               ...
               : n.mozRequestFullScreen
                 ...
                 t && ( t.enter =
                          function() {
                            return u = w.closeOnScroll, w.closeOnScroll = !1,
                        ...
                        t.isFullscreen =
                          function() { return document[this.elementK] } ),
                 t
    }
  }
} );